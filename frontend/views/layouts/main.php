  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="/PlantillaAdv/frontend/web/index.php/users/update/<?= Yii::$app->user->identity->id ?> ">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/PlantillaAdv/frontend/web/index.php/site/red"><i class="fa fa-circle-o"></i><?= Yii::t('app', 'By Levels'); ?></a></li>
          </ul>
        </li>
        <li>
          <a href="#">
